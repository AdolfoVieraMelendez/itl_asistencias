...
<form action="../mConsultasReportes/reportes/Asistencias/generarpdfTodos.php" method="GET" target="_blank">
    <div class="col">
            <button type="submit" name="create_pdf" class="btn btn-outline-primary btn-block activo btnEspacio" id="btnReporteTodos-AS"><i class='fas fa-file-pdf fa-lg'></i> &nbsp; Ver Reporte</button>
    </div>
</form>
