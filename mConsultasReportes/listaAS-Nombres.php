...
<div>
<form action="../mConsultasReportes/reportes/Asistencias/generarpdfNombres.php" method="GET" target="_blank">
    <div class="row">
        ...
        <input type="hidden" name="txtNombre-AS-F" id="txtNombre-AS-F">
        <div class="col">
