...
<div class="table-responsive">
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <form action="../mConsultasReportes/reportes/DocentesAdministrativos/generarpdfApellidos.php" method="GET" target="_blank">
                    <input type="hidden" name="apellidoPaterno-CR" id="apellidoPaterno-CR">
